...
using Tiziano.MyBlog.Web.Controllers.Results;
...
namespace Tiziano.MyBlog.Web.Controllers
{
    ...
    /// 登录注册相关的控制器
    /// </summary>
    public class AccountController : MyBlogControllerBase
    {
        private readonly TenantManager _tenantManager; //多租户管理器
        private readonly UserManager _userManager;     //用户管理器
        private readonly RoleManager _roleManager;     //角色管理器
        private readonly IUnitOfWorkManager _unitOfWorkManager;   //工作单元管理器
        private readonly IMultiTenancyConfig _multiTenancyConfig; //多租户配置
        private readonly LogInManager _logInManager;   //登录管理器
